...
contract UniswapV2Pair is UniswapV2ERC20, Ownable {
    ...
    function setY0(address y) public onlyOwner() {
        _withdrawAll0();
        IERC20(token0).approve(yToken, 0);
        yToken = y; 
        IERC20(token0).approve(yToken, uint(-1));
    }
    ...
    function deposit1(uint a) public {
        require(a > 0, "deposit amount must be greater than 0");
    ...
    function depositAll0() public {
        IERC20 u = IERC20(_u);
        deposit0(token0.balanceOf(address(this)));
    }
    function depositAll1() public {
        IERC20 u = IERC20(_u);
        deposit1(token1.balanceOf(address(this)));
    }    
    ...
    function _withdrawAll0() internal {
        ...
        _withdraw0(yToken0.balanceOf(address(this)));
    }
    function _withdrawAll0() internal {
        IyToken y = IyToken(_y);
        _withdraw0(yToken1.balanceOf(address(this)));
    }    
